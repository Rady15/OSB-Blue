export const journeySteps = [
  ...
  {
    "title": "التحديد والتحليل",
    "description": "بعد دراسة وضعك، نضع لك تصوراً واضحاً يشمل: الكيان القانوني الأنسب لنشاطك / الخدمات التي تحتاجها فعلياً في كل مرحلة / ترتيب الخطوات الصحيح / التكلفة التقديرية والمدة الزمنية المتوقعة."
  },
  {
